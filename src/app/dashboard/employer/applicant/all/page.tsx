...
const AllApplicant=()=>{
    ...
    return (
        ...
        <div className="dashboard-outer">
           ...
           <div className="mb-4 ms-0 show-1023"><button type="button" className="theme-btn toggle-filters"><span className="flaticon-menu-1"></span> Menu</button>
           </div>
                          ...
                          <div className="tabs-box">
                             <div className="react-tabs" data-rttabs="true">
                                ...
                                <div className="tabs-content">
                                   ...
                                   <div className="react-tabs__tab-panel" role="tabpanel" id="panel:r1:1" aria-labelledby="tab:r1:1"></div>
                                   <div className="react-tabs__tab-panel" role="tabpanel" id="panel:r1:2" aria-labelledby="tab:r1:2"></div>
                                </div>
                             </div>
                          </div>
                       </div>
